...
export const PROJECTS: Project[] = [
  ...
  {
    name: 'LeadPilot',
    description: 'AI-powered lead generation tool automating outreach research and prospect scoring for sales teams.',
    tags: ['TypeScript', 'Node.js', 'AI', 'REST API'],
    github: 'https://github.com/sahiljadhav7/LeadPilot',
    icon: '🚀',
  },
  {
    name: 'SecondBrain',
    description: 'Personal knowledge management system for capturing, organizing, and retrieving ideas — built for developers.',
  ...
  },
  {
    ...
    description: 'Full-featured personal finance tracker with budget planning, expense analytics, and visual reports.',
...
export const SKILLS = {
  ...
  'Frameworks / Tools': ['React.js', 'Next.js', 'Node.js', 'Express', 'Git', 'Three.js'],
